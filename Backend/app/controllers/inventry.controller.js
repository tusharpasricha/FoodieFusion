...
const InventoryItem = db.InventoryItems;
...
exports.create = (req, res) => {
    ...
    const inventoryItem = {
        ...
        lowStockAlertThreshold: req.body.lowStockAlertThreshold ? req.body.lowStockAlertThreshold : 10
    };
    ...
    InventoryItem.create(inventoryItem)
        ...
        .catch(err => {
            res.status(500).send({
                message: err.message || "Some error occurred while creating the InventoryItem."
            });
        });
};
